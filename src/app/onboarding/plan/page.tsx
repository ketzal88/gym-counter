        ...
        <div className="space-y-10">
            ...
            <div className="text-center space-y-3">
                ...
                <p className="text-base text-slate-600 dark:text-slate-400">
                    Protocolo de 180 días personalizado para ti
                </p>
            </div>
            ...
            <div className="rounded-xl border-2 border-blue-600 overflow-hidden">
                ...
                <div className="grid grid-cols-3 divide-x divide-slate-200 dark:divide-slate-800 border-b border-slate-200 dark:border-slate-800">
                    <div className="p-4 text-center">
                        ...
                        <div className="text-xs text-slate-500 dark:text-slate-500">días/semana</div>
                    </div>
                    <div className="p-4 text-center">
                        <div className="flex items-center justify-center gap-1 mb-1">
                        ...
                        <div className="text-xs text-slate-500 dark:text-slate-500">días totales</div>
                    </div>
                    <div className="p-4 text-center">
                        <div className="flex items-center justify-center gap-1 mb-1">
                        ...
                        <div className="text-xs text-slate-500 dark:text-slate-500">semanas</div>
                    </div>
                </div>
            ...
            <div className="border border-slate-200 dark:border-slate-800 rounded-lg p-5 bg-slate-50 dark:bg-slate-900">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        Prueba tu plan completo sin compromiso. Después: <span className="font-semibold">$4.99/mes</span> o <span className="font-semibold">$49.90/año</span>.
                    </p>
