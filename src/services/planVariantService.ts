...
export function getVariantDisplayName(variantId: string): string {
    const goalNames: Record<string, string> = {
        ...
        postpartum: 'Recuperación posparto',
    };
    ...
    const goalKeys = ['weight_loss', 'muscle_gain', 'max_strength', 'conditioning', 'toned_abs', 'glute_building', 'fat_burn', 'greek_god', 'postpartum'];
