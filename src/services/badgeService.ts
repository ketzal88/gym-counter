...
async function getUserStats(userId: string) {
  try {
    ...
    return {
      ...
      liftState: trainingState?.liftState || { bench: 0, squat: 0, deadlift: 0, ohp: 0, pullupsLevel: 0, hip_thrust: 0 },
      totalVolume,
      workoutsByHour,
      workoutsByDayOfWeek,
    };
    ...
    return {
      ...
      liftState: { bench: 0, squat: 0, deadlift: 0, ohp: 0, pullupsLevel: 0, hip_thrust: 0 },
      totalVolume: 0,
      workoutsByHour: {},
      workoutsByDayOfWeek: {},
    };
